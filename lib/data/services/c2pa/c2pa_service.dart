...
import 'c2pa_service_stub.dart' if (dart.library.js_interop) 'c2pa_service_web.dart';
...
Future<Map<String, dynamic>?> analyzeC2pa(Uint8List bytes, [String? mimeType]) async {
